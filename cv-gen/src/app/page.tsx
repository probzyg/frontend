...
export default function Home() {
 ...
 const handleWorkExperienceChange = (
  ...
  updatedFields[index][event.target.name as keyof WorkExperience] =
   event.target.value;
 ...
 const addWorkExperience = () => {
  ...
  setInputData({
   ...inputData,
   workExperience: [...workExperience, newField],
  });
 };
 ...
 const handleEducationChange = (
  ...
  updatedEducation[index][event.target.name as keyof Education] =
   event.target.value;
 ...
 const handleLanguagesChange = (
  ...
  updatedLanguages[index][event.target.name as keyof Languages] =
   event.target.value;
   ...
   <main className={styles.main}>
    <div className={styles.input}>
     ...
     <div className={styles.info}>
       ...
       {workExperience.map((experience, index) => {
        return (
         <div key={experience.id}>
          {createInputField<WorkExperience>(
           'all_line',
           'Company',
           'text',
           'company',
          ...
          <div className={styles.inline}>
           ...
           {createInputField<WorkExperience>(
            ...
            '',
            index,
            experience.date_job_to,
            handleWorkExperienceChange
           )}
          </div>
          {createEditableContentField<WorkExperience>(
           'Description',
           `job_description`,
           index,
           workExperience,
      ...
      <button className={styles.button} onClick={addWorkExperience}>
       Add Work Experience
      </button>
     </div>
     <div className={styles.info}>
      ...
      <form>
       {education.map((edu, index) => (
        <div key={edu.id}>
         ...
         {createEditableContentField<Education>(
          'Description',
          'school_description',
          index,
          education,
    ...
    <div className={styles.output} id='output'>
            ...
            <html>
              ...
              <div class='colored_box'></div>
                ...
                <div class='inline'>
                  ...
                  ${
                   fieldChanged.website
                    ? `<p>Website: ${inputData.website}</p>`
                    : ''
                  }
                  ${
                ...
                ${workExperience
                 .map(
                  ...
                  <div class='inline'>
                    ${
                     fieldChanged.job_title
                      ? `<p>${experience.job_title}</p>`
                      : ''
                    }
                    ${
                     fieldChanged.date_job_from
                      ? `<div class='from_to'><p>From ${experience.date_job_from.toString()} till ${
                         fieldChanged.date_job_to
                          ? `<p>${experience.date_job_to.toString()}`
                          : 'now'
                        }</p></div>`
                      : ''
                    }
                  ...
                  ${
                   fieldChanged.job_description
                    ? `<ul>${experience.job_description}</ul>`
                    : ''
                  }
                  </div>
                  `
                   ...
                   `
                    <div key=${index}>
                      ...
                      <div class='inline'>
                        ${
                         fieldChanged.degree
                          ? `<div class='from_to'><p>${education.degree} - ${
                             fieldChanged.gpa ? `<p>${education.gpa}` : ''
                            }</p></div>`
                          : ''
                        }
                        ${
                         fieldChanged.date_school_from
                          ? `<div class='from_to'><p>From ${education.date_school_from.toString()} till ${
                             fieldChanged.date_school_to
                              ? `<p>${education.date_school_to.toString()}`
                              : 'now'
                            }</p></div>`
                          : ''
                        }
                      ...
                      ${
                       fieldChanged.school_description
                        ? `<ul>${education.school_description}</ul>`
                        : ''
                      }
                    </div>
                  `
                ...
                <div>
                  ${
                   fieldChanged.skills_list
                    ? `<ul>${inputData.skills_list}</ul>`
                    : ''
                  }
                </div>
                <h3>Languages</h3>
                      ...
                      <div class='inline'>
                        ...
                        ${
                         fieldChanged.language
                          ? `<div class='from_to'><p>${languages.language} - ${
                             fieldChanged.rating ? `<p>${languages.rating}` : ''
                            }</p></div>`
                          : ''
                        }
                      </div>
     ...
     />
     <button className={styles.button} onClick={() => downloadPDF(iframeRef)}>
      Download PDF
     </button>
    </div>
   </main>
